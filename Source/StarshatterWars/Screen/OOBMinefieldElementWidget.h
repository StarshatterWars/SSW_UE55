...
#include "OOBMinefieldElementWidget.generated.h"

class UTextBlock;
class UImage;
class UOOBUnitItem; // The Data Object class holding FS_OOBForce
class UListView;
struct FS_OOBMinefieldUnit;

/**
 * 
 */
UCLASS()
class STARSHATTERWARS_API UOOBMinefieldElementWidget : public UUserWidget,  public IUserObjectListEntry
{
	GENERATED_BODY()
public:
    UPROPERTY()
