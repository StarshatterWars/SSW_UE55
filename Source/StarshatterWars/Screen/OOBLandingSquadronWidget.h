...
#include "OOBLandingSquadronWidget.generated.h"

class UTextBlock;
class UImage;
class UListView;
struct FS_OOBLanding;

/**
 * 
 */
UCLASS()
class STARSHATTERWARS_API UOOBLandingSquadronWidget : public UUserWidget, public IUserObjectListEntry
{
	GENERATED_BODY()
	public:
