...
bool Mission::Load(const char* fn, const char* fp)
{
	return false;
}
...
MissionElement* Mission::FindElement(const char* elem_name)
{
	return nullptr;
}
...
void Mission::SetStarSystem(AStarSystem* s)
{
}
...
Text Mission::Serialize(const char* player_elem, int player_index)
{
	return Text();
}
...
/*void
Mission::SetStarSystem(AStarSystem* s)
{
	if (star_system != s) {
		star_system = s;
