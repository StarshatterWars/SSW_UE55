...
void UCamera::Initialize(double x, double y, double z)
{
	pos.x = x;
	pos.y = y;
	pos.z = z;
...
void
UCamera::MoveTo(double x, double y, double z)
{
	pos.x = x;
	pos.y = y;
	pos.z = z;
...
void
UCamera::MoveBy(double dx, double dy, double dz)
{
	pos.x += dx;
	pos.y += dz;
	pos.z += dy;
...
void
UCamera::Clone(const UCamera* cam)
{
	pos = cam->pos;
...
void
UCamera::LookAt(const Point& target, const Point& eye, const Point& up)
{
...
void
UCamera::LookAt(const Point& target)
{
	// No navel gazing:
	if (target == Pos())
		return;
...
bool
UCamera::Padlock(const Point& target, double alimit, double e_lo, double e_hi)
{
	// No navel gazing:
	if (target == Pos())
		return false;
