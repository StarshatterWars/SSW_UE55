...
// Minimal Unreal includes (required for FVector):
...
public:
	...
	static void       SetListener(const Camera& cam, const FVector& vel);
...
public:
	...
	virtual void           SetLocation(const FVector& l) { location = l; }
