...
void
Window::DrawLine(int x1, int y1, int x2, int y2, const FColor& color, int blend)
{
...
void
Window::DrawRect(int x1, int y1, int x2, int y2, const FColor& color, int blend)
{
    if (!screen || !screen->GetVideo()) return;
...
void
Window::DrawRect(const Rect& r, const FColor& color, int blend)
{
...
void
Window::FillRect(const Rect& r, const FColor& color, int blend)
{
...
void
Window::DrawLines(int nPts, const FVector* pts, const FColor& color, int blend)
{
    if (nPts < 2 || nPts > 16)
        return;
...
void
Window::DrawPoly(int nPts, const FVector* pts, const FColor& color, int blend)
{
    if (nPts < 3 || nPts > 8)
        return;
...
void
Window::FillPoly(int nPts, const FVector* pts, const FColor& color, int blend)
{
    if (nPts < 3 || nPts > 4)
        return;
...
void
Window::FadeBitmap(int x1, int y1, int x2, int y2, Bitmap* img, const FColor& c, int blend)
{
    Rect clip_rect;
    clip_rect.w = rect.w;
    clip_rect.h = rect.h;
...
void
Window::DrawEllipse(int x1, int y1, int x2, int y2, const FColor& color, int blend)
{
...
void
Window::FillEllipse(int x1, int y1, int x2, int y2, const FColor& color, int blend)
{
    Video* video = screen ? screen->GetVideo() : 0;
    if (!video) return;
