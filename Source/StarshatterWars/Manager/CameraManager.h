...
class CameraManager : public SimObserver
{
public:
	static const char* TYPENAME() { return "CameraManager"; }
	...
	int operator==(const CameraManager& that) const { return this == &that; }
...
protected:
	...
	// Converted Starshatter Point -> Unreal FVector
	FVector            external_point;
	FVector            base_loc;
