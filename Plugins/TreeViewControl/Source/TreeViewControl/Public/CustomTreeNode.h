...
typedef TSharedPtr< class CustomTreeNode > TreeNodePtr;
...
private:
	...
	TWeakPtr< CustomTreeNode > ParentDir;
...
public:
	...
	/** Constructor for CustomTreeNode */
	CustomTreeNode(TreeNodePtr IN_ParentDir, FString IN_DirectoryPath, FString IN_DisplayName , int32 IN_NodeID, int32 IN_ParentID , FMargin IN_TreeNodePadding , TArray<FString> IN_ExtraStrings)
	{
